...
### Smart Auto Scroll
- Scroll **tự bật** khi agent đang generate, **tự tắt** khi agent xong
- Dùng MutationObserver phát hiện thay đổi nội dung chat panel
- Không còn bị scroll kéo xuống khi muốn kéo lên đọc
- Thời gian chờ vẫn tùy chỉnh qua Settings (scrollPauseMs)
