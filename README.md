...
### v6.4.1 (Latest)
- **Fix 'Corrupt Installation' Warning** — Tự động cập nhật checksums trong product.json sau khi inject, xóa hoàn toàn cảnh báo "Your Antigravity installation appears to be corrupt"
